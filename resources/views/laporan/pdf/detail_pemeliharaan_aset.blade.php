...
<body>
    ...
    <table class="info-table">
        ...
        <tr>
            <td width="20%"><strong>NUP</strong></td>
            <td width="30%">: {{ $aset->nup }}</td>
            <td width="20%"><strong>Nilai Perolehan</strong></td>
            <td width="30%">: Rp {{ number_format($aset->nilai_perolehan_pertama, 0, ',', '.') }}</td>
        </tr>
        <tr>
