...
@section('header')
    <div class="flex items-center justify-between gap-4 w-full">
        ...
        <div>
            <a href="{{ route('operator.ruangan.edit', $ruangan->id) }}" class="px-5 py-2.5 bg-sky-700 text-white rounded-xl text-sm font-bold hover:bg-sky-800 transition-all duration-300 shadow-sm flex items-center gap-2">
                                ...
                                @foreach($ruangan->asetBmn as $aset)
                                    <tr class="hover:bg-sky-50/50 transition-colors duration-200 group">
                                        <td class="px-6 py-4 whitespace-nowrap text-left text-sm font-bold text-slate-900">
                                            <a href="{{ route('operator.aset.show', $aset->id) }}" class="hover:text-blue-600 transition-colors">
                                                {{ $aset->nama_barang }}
                                            </a>
                                        </td>
