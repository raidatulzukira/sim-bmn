                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        @foreach($alertPeminjaman as $pinjam)
                                            <tr>
                                                ...
                                                <td class="px-4 py-2 whitespace-nowrap text-sm text-gray-900">{{ $pinjam->asetBmn->nama_barang }}</td>
                                ...
                                <table class="min-w-full divide-y divide-gray-200">
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        @foreach($alertPemeliharaan as $rawat)
                                            <tr>
                                                <td class="px-4 py-2 whitespace-nowrap text-sm text-gray-900">{{ $rawat->asetBmn->nama_barang }}</td>
