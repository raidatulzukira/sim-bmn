                            ...
                            @forelse($pemeliharaans as $rawat)
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                        ...
                                        <br><span class="text-xs text-gray-400 font-mono">{{ $rawat->asetBmn->kode_barang }}</span>
                                    </td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $rawat->jenis === 'situasional' ? $rawat->pelapor->name : 'Operator' }}</td>
