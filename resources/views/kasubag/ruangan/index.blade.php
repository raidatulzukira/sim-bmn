                        ...
                        <tbody class="bg-white divide-y divide-slate-50">
                            @forelse($ruangans as $index => $ruangan)
                                <tr class="hover:bg-sky-50/50 transition-colors duration-200 group">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-center">
                                        <a href="{{ route('kasubag.ruangan.show', $ruangan->id) }}" title="Detail" class="inline-flex items-center justify-center w-10 h-10 text-blue-600 bg-blue-50 rounded-lg hover:bg-blue-100 hover:text-blue-900 transition-colors shadow-sm">
